        ...
        if (i) {
            ...
            (u = "scroll" + n.d2),
                T(
                    ...
                    (y && 20 < b) ||
                        (!y &&
                            (f ? Math.max(Se[u], x[u]) : i.parentNode[u]) <=
                                b + 1)
                ),
                f &&
                    ((l = ea(a)),
            ...
            for (var t, r, n = e.t.style, o = e.length, i = 0; i < o; i += 2)
                (r = e[i + 1]),
                    ...
                    r
                        ? (n[t] = r)
                        : n[t] &&
                          n.removeProperty(t.replace(k, "-$1").toLowerCase());
        },
        Ke = { left: 0, top: 0 },
        ...
        ((ScrollTrigger.prototype.init = function init(y, x) {
            if (((this.progress = 0), this.vars && this.kill(1), Fe)) {
                var d,
                    ...
                    $,
                    K = (y = da(
                        F(y) || H(y) || y.nodeType ? { trigger: y } : y,
                        Ue
                    )).horizontal
                        ? Je
                        : Xe,
                ...
                (se *= 45),
                    ...
                    (me.revert = function (e) {
                        var t = !1 !== e;
                        t !== w &&
                            (me.update(t), oe && t && Ca(oe, N, A), (w = t));
                    }),
                    (me.refresh = function (e) {
                        if (!Me && $)
                            if (oe && e && ze)
                                ia(ScrollTrigger, "scrollEnd", be);
                            else {
                                var t = Math.max(
                                        me.scroll(),
                                        me.scroll.rec || 0
                                ...
                                var n,
                                    ...
                                    m =
                                        ...
                                        (oe || !ne ? "0 0" : "0 100%"),
                                    b =
                                        (oe && Math.max(0, Ve.indexOf(me))) ||
                                        0;
                                if (b)
                                    for (l = b; l--; )
                                        Ve[l].pin === oe && Ve[l].revert();
                                if (
                                    ((T =
                                        Ja(
                                            m,
                            ...
                            if (
                                ...
                                ue ||
                                    (!V || Me || Ee
                                        ...
                                        : ((V.vars.totalProgress = c),
                                          V.invalidate().restart())),
                                oe)
                            )
                                if (
                                    (e && ie && (N.style[ie + K.os2] = m), de)
                                ) {
                                    if (i) {
                                        if (
                                            ((o = !e && s + 1 >= E(pe, K)), fe)
