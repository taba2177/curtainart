                ...
                ? ((n = e.charAt(0)),
                  ...
                  "<" === n || ">" === n
                      ...
                      : ((n = parseFloat(e.charAt(i - 1) + e.substr(i + 1))),
                        a &&
                            r &&
                            (n = (n / 100) * (H(r) ? r[0] : r).totalDuration()),
                        1 < i
        ...
        Nt =
            ...
            (Rt.repeatDelay = function repeatDelay(t) {
                if (arguments.length) {
                    var e = this._time;
                    return (
                        (this._rDelay = t), Ja(this), e ? this.time(e) : this
                    );
                }
                return this._rDelay;
            }),
            ...
            (Rt.invalidate = function invalidate() {
                return (
                    (this._initted = this._act = 0), (this._zTime = -U), this
                );
            }),
    ...
    var qt = (function (n) {
        ...
        return (
            ...
            (e.render = function render(t, e, r) {
                ...
                if (v !== this._tTime || r || y) {
                    ...
                    if (
                        ...
                        return (
                            (this._start = f), ya(this), this.render(t, e, r)
                        );
            ...
            (e.previousLabel = function previousLabel(t) {
                return (
                    void 0 === t && (t = this._time), ib(this, bt(this, t), 1)
                );
            }),
            ...
            (Timeline.updateRoot = function updateRoot(t) {
                if (
                    (R._ts && (fa(R, xa(t, R)), (f = St.frame)), St.frame >= ct)
                ) {
                    ct += Y.autoSleep || 120;
                    var e = R._first;
                    if (
                  ...
                  ? ((l[f ? "width" : "height"] = 100 + (p ? h : i)),
                    ...
                    (s = a._gsap) && m && s.width && f && s.time === St.time
                        ...
                        : ((!m && "%" !== h) ||
                          ...
                          f &&
                              m &&
                              (((s = _(a)).time = St.time), (s.width = a[c])),
            ...
            return (
                ...
                m !== Ge &&
                    ...
                    r.svg &&
                        ...
                        (r.forceCSS =
                            t.setAttribute("transform", "") || !Id(od(t, Ye))),
