...
<section class="{{ $class ?? '' }}">
    <div class="hero-breadcurmb pt-150px md:pt-40 lg:pt-200px pb-50px md:pb-60px lg:pb-100px bg-cover bg-center bg-no-repeat relative z-1 after:absolute after:top-0 after:left-0 after:w-full after:h-full after:bg-primary-color-light after:-z-1 after:opacity-70"
        style="background-image: url('{{ $backgroundImage ?? $post->getRandomImage() }}')">
        <div class="container">
