...
<div class="our-projects" id="{{ $category->slug ?? 'projects' }}">
        ...
        <div class="container-fluid">
            ...
            <div class="row justify-content-center">
                <div class="col-lg-8 col-md-10">
                    <div class="project-item wow fadeInUp group">
            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-md-6">
                    <div class="project-item wow fadeInUp group" data-wow-delay="{{ ($loop->index + 1) * 0.25 }}s">
                        <div class="project-image" data-cursor-text="">
                            <a href="{{ $post->url }}">
                                <figure>
                                    <img src="{{ $post->image?->url ?? $post->getRandomImage() }}" alt="{{ $post->title }}">
            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="project-item wow fadeInUp group" data-wow-delay="{{ (($loop->index % 4) + 1) * 0.25 }}s">
                        <div class="project-image" data-cursor-text="">
                            <a href="{{ $post->url }}">
                                <figure>
                                    <img src="{{ $post->image?->url ?? $post->getRandomImage() }}" alt="{{ $post->title }}">
            ...
            <div class="project-footer-btn wow fadeInUp" data-wow-delay="1.25s">
                <a href="{{ route('dynamic.route', $category->slug) }}" class="btn-default">{{ $category->name }}</a>
            </div>
            @endif
        </div>
    </div>
